...
CREATE TABLE `accesslog` (
  `handler` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
  `remoteaddress` char(15) COLLATE utf8mb4_general_ci NOT NULL,
  `useragent` varchar(256) COLLATE utf8mb4_general_ci NOT NULL,
  `formvalues` varchar(1024) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `event` (
  ...
  `thinit` int DEFAULT '50',
  `thdelta` int DEFAULT '5',
  `achk` int DEFAULT '0',
  `aclr` int DEFAULT '0',
  PRIMARY KEY (`eventid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `giftranking` (
  ...
  `norder` int NOT NULL,
  `cntrblst` int NOT NULL DEFAULT '0',
...
--
-- Table structure for table `giftscorecntrb`
--

DROP TABLE IF EXISTS `giftscorecntrb`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `giftscorecntrb` (
  `giftid` int NOT NULL,
  `userno` int NOT NULL,
...
-- Dump completed on 2024-12-05 20:17:30
